...
\itkcaption[qual]{Visual qualitative results.
Same data and order as in Fig.~\ref{fig:Eval4}.
Cyan, yellow and green pixels are false positives (oversegmentation).
Violet, red and blue are false negatives (undersegmentation).}
\label{fig:qual}
\end{figure}
...
\includegraphics[scale=0.7]{c10l-a.pdf}
...
adding sparsity exacerbates the problem -- most errors are false negatives (undersegmentation).}
\label{fig:c10l}
\end{figure}
